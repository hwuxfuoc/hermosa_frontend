...
public class AlsoLikeAdapter extends RecyclerView.Adapter<AlsoLikeAdapter.VH> {
    ...
    public AlsoLikeAdapter(Context context, List<Product> list, OnAddToCartListener listener) {
