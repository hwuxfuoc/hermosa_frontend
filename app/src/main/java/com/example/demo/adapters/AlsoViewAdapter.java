...
public class AlsoViewAdapter extends RecyclerView.Adapter<AlsoViewAdapter.VH> {
    ...
    public AlsoViewAdapter(Context context, List<Product> list, OnAddToCartListener listener) {
