...
public class ProductData {
    ...
    public static void initializeData() {
        ...
        // ==================== CAKE ====================
        allProducts.add(new Product("C04", "Strawberry Cheese", "85000 VND", R.drawable.cake_strawberry_cheese,
                Color.parseColor("#F1BCBC"),
        ...
        allProducts.add(new Product("C02", "Yellow Lemon Cheese", "90000 VND", R.drawable.cake_yellow_lemon_cheese,
                Color.parseColor("#A55102"),
        ...
        allProducts.add(new Product("C03", "Blueberry Cheese", "85000 VND", R.drawable.cake_blueberry_cheese,
                Color.parseColor("#1F2831"),
        ...
        allProducts.add(new Product("C040", "Tiramisu Chocolate", "75000 VND", R.drawable.cake_tiramisu_chocolate,
                Color.parseColor("#562715"),
        ...
        allProducts.add(new Product("C05", "Tiramisu Matcha", "85000 VND", R.drawable.cake_tiramisu_matcha,
                Color.parseColor("#727C26"),
        ...
        allProducts.add(new Product("C06", "Eclair Cake", "90000 VND", R.drawable.cake_eclair_cake,
                Color.parseColor("#4F252D"),
        ...
        allProducts.add(new Product("C07", "Truffle Cake", "60000 VND", R.drawable.cake_truffle_cake,
                Color.parseColor("#FAE4B0"),
        ...
        allProducts.add(new Product("C08", "Opera Chocolate", "75000 VND", R.drawable.cake_opera_chocolate,
                Color.parseColor("#4F252D"),
        ...
        allProducts.add(new Product("C09", "Strawberry Donut", "50000 VND", R.drawable.cake_strawberry_donut,
                Color.parseColor("#E95B7C"),
        ...
        allProducts.add(new Product("C10", "Matcha Donut", "55000 VND", R.drawable.cake_matcha_donut,
                Color.parseColor("#8DA813"),
        ...
        allProducts.add(new Product("C11", "Egg Tart", "20000 VND", R.drawable.cake_egg_tart,
                Color.parseColor("#F4BD35"),
        ...
        allProducts.add(new Product("C12", "Mixed Macarons", "40000 VND", R.drawable.cake_mixed_macaron,
                Color.parseColor("#935427"),
        ...
        allProducts.add(new Product("C13", "Original Croissant", "35000 VND", R.drawable.cake_croissant,
                Color.parseColor("#964E12"),
        ...
        allProducts.add(new Product("C14", "Chocolate Croissant", "45000 VND", R.drawable.cake_chocolate_croissant,
                Color.parseColor("#562715"),
        ...
        // ==================== DRINK ====================
        allProducts.add(new Product("D01", "Strawberry Smooth", "100000 VND", R.drawable.drink_strawberry_smooth,
                Color.parseColor("#A71317"),
        ...
        allProducts.add(new Product("D02", "Caramel Smooth", "85000 VND", R.drawable.drink_caramel_smooth,
                Color.parseColor("#E68E09"),
        ...
        allProducts.add(new Product("D03", "Oreo Smooth", "85000 VND", R.drawable.drink_oreo_smooth,
                Color.parseColor("#220203"),
        ...
        allProducts.add(new Product("D04", "Blueberry Smooth", "100000 VND", R.drawable.drink_blueberry_smooth,
                Color.parseColor("#865163"),
        ...
        allProducts.add(new Product("D05", "Matcha Latte", "100000 VND", R.drawable.drink_matcha_latte,
                Color.parseColor("#526218"),
        ...
        allProducts.add(new Product("D06", "Chocolate Milk Tea", "100000 VND", R.drawable.drink_chocolate_milk_tea,
                Color.parseColor("#D7A95E"),
        ...
        allProducts.add(new Product("D07", "Black Ice Coffee", "60000 VND", R.drawable.drink_black_ice_coffee,
                Color.parseColor("#220203"),
        ...
        allProducts.add(new Product("D08", "Milk Coffee", "70000 VND", R.drawable.drink_milk_coffee,
                Color.parseColor("#964E12"),
        ...
        allProducts.add(new Product("D09", "Hot Coffee", "50000 VND", R.drawable.drink_hot_coffee,
                Color.parseColor("#220203"),
                "A classic cup of freshly brewed hot coffee with a deep aroma and balanced flavor — simple, strong, and satisfying.", "drink"));

        allProducts.add(new Product("D10", "Green Tea", "50000 VND", R.drawable.drink_green_tea,
                Color.parseColor("#4C4116"),
        ...
        allProducts.add(new Product("D11", "Guava Tea", "70000 VND", R.drawable.drink_guava_tea,
                Color.parseColor("#FBA79E"),
        ...
        allProducts.add(new Product("D12", "Longan Tea", "70000 VND", R.drawable.drink_longan_tea,
                Color.parseColor("#D7A95E"),
        ...
        // ==================== FOOD ====================
        allProducts.add(new Product("F01", "Sandwich", "50000 VND", R.drawable.food_sandwich,
                Color.parseColor("#E1B55C"),
        ...
        allProducts.add(new Product("F02", "Fried Chicken Burger", "60000 VND", R.drawable.food_burger,
                Color.parseColor("#A55102"),
